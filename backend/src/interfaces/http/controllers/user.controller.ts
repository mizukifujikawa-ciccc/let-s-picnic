...
//     const user = await userRepository.createUser({firstName, lastName, email, hashedPassword, role});
...
//     const user = await userRepository.editUser(id, {firstName, lastName, email, role})
